...
public class HiveDemo {	
	...
	* @throws
	 */
	public void demoForQuery2() throws SQLException{
		String databaseName = "default";
		hiveTools mhivetool = new hiveTools();
		Connection conn = mhivetool.getConnection();
		mhivetool.useDatabase(conn, databaseName); 
		...
		String tableFormat = 
				" (ID int, TIME string, a int, b int, name string, value double, fliget string) ";
		String params2[] = {};
		String Hivesql = "FROM t1112120152020 se " +
				"INSERT OVERWRITE TABLE" + tmpTableName  +
				" SELECT id,time,a,b,name,value,flight " +
				"WHERE se.day > 'p20131102' AND se.day < 'p20150102' AND se.name != 'XXX'";
		@SuppressWarnings("unchecked")
	...
	* @throws
	 */
	public void demoForQuery() throws SQLException{
		String databaseName = "default";
		hiveTools mhivetool = new hiveTools();
		Connection conn = mhivetool.getConnection();
		mhivetool.useDatabase(conn, databaseName); 
